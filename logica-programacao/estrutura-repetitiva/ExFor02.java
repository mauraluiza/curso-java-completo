...
public class ExFor02 {
	public static void main(String[] args) {
		...
		/*
		 * Exercício 02 (URI 1072): Leia um valor inteiro N. Este valor será a quantidade 
		 * de valores inteiros X que serão lidos em seguida. Mostre quantos destes valores X
